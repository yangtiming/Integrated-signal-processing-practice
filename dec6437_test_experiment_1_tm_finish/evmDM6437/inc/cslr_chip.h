...
#define CSL_CHIP_IER_RESETVAL            (0x00000000u)
...
#define CSL_CHIP_ARP_ARP_MASK            (0xFFFFFFFFu)
#define CSL_CHIP_ARP_ARP_SHIFT           (0x00000000u)
#define CSL_CHIP_ARP_ARP_RESETVAL        (0x00000000u)

#define CSL_CHIP_ARP_RESETVAL            (0x00000000u)
...
#define CSL_CHIP_DIER_DIER_MASK          (0xFFFFFFFFu)
#define CSL_CHIP_DIER_DIER_SHIFT         (0x00000000u)
#define CSL_CHIP_DIER_DIER_RESETVAL      (0x00000000u)

#define CSL_CHIP_DIER_RESETVAL           (0x00000000u)
...
#define CSL_CHIP_TSR_DBGM_MASK           (0x00000010u)
#define CSL_CHIP_TSR_DBGM_SHIFT          (0x00000004u)
#define CSL_CHIP_TSR_DBGM_RESETVAL       (0x00000000u)
#define CSL_CHIP_TSR_DBGM_EMU_ENABLE     (0x00000000u)
#define CSL_CHIP_TSR_DBGM_EMU_DISABLE    (0x00000001u)
...
#define CSL_CHIP_ITSR_DBGM_MASK          (0x00000010u)
#define CSL_CHIP_ITSR_DBGM_SHIFT         (0x00000004u)
#define CSL_CHIP_ITSR_DBGM_RESETVAL      (0x00000000u)
#define CSL_CHIP_ITSR_DBGM_EMU_ENABLE    (0x00000000u)
#define CSL_CHIP_ITSR_DBGM_EMU_DISABLE   (0x00000001u)
...
#define CSL_CHIP_NTSR_DBGM_MASK          (0x00000010u)
#define CSL_CHIP_NTSR_DBGM_SHIFT         (0x00000004u)
#define CSL_CHIP_NTSR_DBGM_RESETVAL      (0x00000000u)
#define CSL_CHIP_NTSR_DBGM_EMU_ENABLE    (0x00000000u)
#define CSL_CHIP_NTSR_DBGM_EMU_DISABLE   (0x00000001u)
...
#define CSL_CHIP_ETSR_IB_MASK            (0x00008000u)
#define CSL_CHIP_ETSR_IB_SHIFT           (0x0000000Fu)
#define CSL_CHIP_ETSR_IB_RESETVAL        (0x00000000u)

#define CSL_CHIP_ETSR_SPLX_MASK          (0x00004000u)
#define CSL_CHIP_ETSR_SPLX_SHIFT         (0x0000000Eu)
#define CSL_CHIP_ETSR_SPLX_RESETVAL      (0x00000000u)

#define CSL_CHIP_ETSR_EXC_MASK           (0x00000400u)
#define CSL_CHIP_ETSR_EXC_SHIFT          (0x0000000Au)
#define CSL_CHIP_ETSR_EXC_RESETVAL       (0x00000000u)

#define CSL_CHIP_ETSR_INT_MASK           (0x00000200u)
#define CSL_CHIP_ETSR_INT_SHIFT          (0x00000009u)
#define CSL_CHIP_ETSR_INT_RESETVAL       (0x00000000u)

#define CSL_CHIP_ETSR_CXM_MASK           (0x000000C0u)
#define CSL_CHIP_ETSR_CXM_SHIFT          (0x00000006u)
#define CSL_CHIP_ETSR_CXM_RESETVAL       (0x00000000u)

#define CSL_CHIP_ETSR_DBGM_MASK          (0x00000010u)
#define CSL_CHIP_ETSR_DBGM_SHIFT         (0x00000004u)
#define CSL_CHIP_ETSR_DBGM_RESETVAL      (0x00000000u)

#define CSL_CHIP_ETSR_XEN_MASK           (0x00000008u)
#define CSL_CHIP_ETSR_XEN_SHIFT          (0x00000003u)
#define CSL_CHIP_ETSR_XEN_RESETVAL       (0x00000000u)

#define CSL_CHIP_ETSR_GEE_MASK           (0x00000004u)
#define CSL_CHIP_ETSR_GEE_SHIFT          (0x00000002u)
#define CSL_CHIP_ETSR_GEE_RESETVAL       (0x00000000u)

#define CSL_CHIP_ETSR_SGIE_MASK          (0x00000002u)
#define CSL_CHIP_ETSR_SGIE_SHIFT         (0x00000001u)
#define CSL_CHIP_ETSR_SGIE_RESETVAL      (0x00000000u)

#define CSL_CHIP_ETSR_GIE_MASK           (0x00000001u)
#define CSL_CHIP_ETSR_GIE_SHIFT          (0x00000000u)
#define CSL_CHIP_ETSR_GIE_RESETVAL       (0x00000000u)

#define CSL_CHIP_ETSR_RESETVAL           (0x00000000u)
...
#define CSL_CHIP_IERR_IERR_MASK          (0xFFFFFFFFu)
#define CSL_CHIP_IERR_IERR_SHIFT         (0x00000000u)
#define CSL_CHIP_IERR_IERR_RESETVAL      (0x00000000u)

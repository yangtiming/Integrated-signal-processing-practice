...
/* MODULE PARAMETERS */
-u _EVMDM6437_init
GBL_USERINITFXN = _EVMDM6437_init;
...
MEMORY {
   ...
   BootLoader  : origin = 0x10800000,  len = 0x800
   CACHE_L2    : origin = 0x10800800,  len = 0x20000
}
/* MODULE CLK */
SECTIONS {
   .clk: {
...
SECTIONS {
        ...
        /* DVTEvent_Log buffer */
        .DVTEvent_Log$buf: align = 0x8000 {} > DDR2
       ...
       .hst0: align = 0x4 {} > DDR2
        ...
        .stack: {
            GBL_stackbeg = .;
            *(.stack)
            GBL_stackend = GBL_stackbeg + 0x20000 - 1;
            _HWI_STKBOTTOM = GBL_stackbeg + 0x20000 - 4 & ~7;
